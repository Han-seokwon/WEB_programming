...
<body>
  ...
  <form action='process_update.py' method='post' autocomplete='on'>
      <input type='hidden' name='pageID' value='{form_default_title}'>
      <p><input type="text" name='title' placeholder='title' value='{form_default_title}'></p>
      <p><textarea rows='15' cols='50' name='description' placeholder='description'>{form_default_description}</textarea></p>
...
list_tag=cgiPkg.file_access.get_list(), form_default_title=pageID,
